...
if __name__ == '__main__':
    ...
    for i in range(1,tN):
        ...
        arg0 = (m30ic, xhist[0:i+1,:],yhist[0:i+1,0][:,None])
        arg1 = (m31ic, xhist[0:i+1,:],yhist[0:i+1,1][:,None])
        arg2 = (m32ic, xhist[0:i+1,:],yhist[0:i+1,2][:,None])
        args = [arg0, arg1, arg2]
        pool.map(updateModel, args)
        #pool.apply_async(m30ic.set_XY, [xhist[0:i+1,:],yhist[0:i+1,0][:,None]])
