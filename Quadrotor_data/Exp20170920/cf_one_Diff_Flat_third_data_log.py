...
#-------------------------Actual control experiment--------------------#
    ...
    while not (rospy.is_shutdown() or t_real*dt>t_total):
        ...
        try:
            ...
            break
    # save data
    f = open('cf1_3rd_data_09142017.pckl', 'w')
    pickle.dump([t_hist, p_hist, phat_hist, ptrack_hist, u_hist, uhat_hist, cmd_hist, cmdreal_hist, rpytrack_hist, imu_hist, gyro_hist], f)
    f.close()
