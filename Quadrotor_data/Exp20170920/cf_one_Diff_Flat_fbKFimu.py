...
#-------------------------Actual control experiment--------------------#
    ...
    # save data
    f = open('cf1_Diff_Flat20170423fbimu01.pckl', 'w')
    pickle.dump([t_hist, p_hist, phat_hist, ptrack_hist, u_hist, uhat_hist, cmd_hist, cmdreal_hist, rpytrack_hist, imu_hist], f)
    f.close()
